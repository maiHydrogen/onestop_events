            ...
            child: Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  hintStyle: OTextStyle.bodyMedium.copyWith(color: OColor.gray600),
                  prefixIcon: Icon(TablerIcons.search, color: OColor.gray500),
                    ...
                    if (savedEvents.isEmpty) {
                      return Center(
                        child: Column(
                          ...
                          children: [
                            Icon(TablerIcons.bookmark_off, size: 64, color: OColor.gray400),
